class PageElements {
  ...
  constructor(page) {
    ...
    this.navCart = page.locator('a[href="/view_cart"]:has(.fa-shopping-cart)');
    ...
    this.tituloHeader = page.getByRole('heading', { name: 'Full-Fledged practice website for Automation Engineers' });
